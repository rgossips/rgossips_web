    ...
    <section className="w-full py-6 px-6 bg-white">
      ...
      <div className="flex flex-col gap-10">
        {servicesData.map((service) => (
          <div key={service.id} className="relative w-full h-52">
            {/* Background Image */}
            <div className="w-[85%] h-full rounded-[32px] overflow-hidden shadow-md">
              <img
                src={service.bgImage}
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[60%] bg-white rounded-[24px] shadow-xl p-4 border border-slate-50">
