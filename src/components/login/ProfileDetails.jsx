    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          ...
          <select className="flex h-12 w-full items-center justify-between rounded-xl border border-slate-200 bg-white px-12 py-2 text-sm ring-offset-white focus:outline-none focus:ring-2 focus:ring-[#6347F9] appearance-none">
