...
export default function BrandSupportChat({ open, onClose }) {
  ...
  return createPortal((
    <div data-scroll-lock className="fixed inset-0 z-[400] flex items-end sm:items-center justify-center sm:justify-end bg-black/30 backdrop-blur-sm p-0 sm:p-6">
      <motion.div
      ...
      >
        ...
        {!callbackOpen && (
          <div className="px-5 pt-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:pb-3 border-t border-[#E4E9F4] shrink-0">
            <button
              onClick={() => {
                setMessages((prev) => [
                  ...prev,
