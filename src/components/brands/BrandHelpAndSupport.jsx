      ...
      <div className="relative bg-white w-full max-w-xl h-full flex flex-col shadow-2xl animate-in slide-in-from-right duration-200">
        ...
        <div className="sticky top-0 z-10 bg-white px-6 py-5 flex items-center gap-4 border-b border-[#E4E9F4]">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-lg font-black tracking-tight text-[#16224E]">{t("header.title")}</h1>
            <p className="text-[11px] text-[#9C97B8] font-bold">{t("header.subtitle")}</p>
          </div>
          <button
            onClick={onClose}
            className="w-9 h-9 rounded-full bg-slate-100 flex items-center justify-center text-[#6B6785] hover:bg-slate-200 cursor-pointer"
            aria-label={t("close")}
          >
            <X size={18} />
          </button>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="relative group">
            <Search
              className="absolute left-4 top-1/2 -translate-y-1/2 text-[#9C97B8] group-focus-within:text-purple-500 transition-colors"
              size={18}
            />
            <input
              type="text"
              ...
              className="w-full bg-slate-50 border border-[#E4E9F4] rounded-xl py-4 pl-11 pr-5 text-sm font-bold focus:outline-none focus:ring-4 focus:ring-purple-50 transition-all placeholder:text-gray-300"
            />
          </div>

          {/* Contact options */}
          <section className="space-y-3">
            <h3 className="text-[11px] font-black text-[#9C97B8] uppercase tracking-[0.15em] ml-1">
              {t("contactUs")}
            </h3>
            <div className="grid grid-cols-1 gap-3">
              {onOpenChat && (
                <button
                  type="button"
                  onClick={onOpenChat}
                  className="group flex items-center gap-4 p-4 bg-white border border-[#E4E9F4] rounded-2xl hover:border-purple-200 hover:shadow-sm transition-all text-left cursor-pointer"
                >
                  <div className="w-11 h-11 rounded-xl bg-[#6A66C9] text-white flex items-center justify-center shadow-sm">
                    <MessageCircle size={20} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-[10px] font-black text-[#9C97B8] uppercase tracking-widest">{t("labels.liveChat")}</p>
                    <p className="text-sm font-bold text-gray-800 group-hover:text-[#6A66C9] transition-colors">
                      {t("liveChatValue")}
                    </p>
                  </div>
              ...
              <a
                ...
                className="group flex items-center gap-4 p-4 bg-white border border-[#E4E9F4] rounded-2xl hover:border-blue-200 hover:shadow-sm transition-all"
              >
                <div className="w-11 h-11 rounded-xl bg-blue-500 text-white flex items-center justify-center shadow-sm">
                  <Mail size={20} />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-black text-[#9C97B8] uppercase tracking-widest">{t("labels.email")}</p>
              ...
              <a
                ...
                className="group flex items-center gap-4 p-4 bg-white border border-[#E4E9F4] rounded-2xl hover:border-emerald-200 hover:shadow-sm transition-all"
              >
                <div className="w-11 h-11 rounded-xl bg-emerald-500 text-white flex items-center justify-center shadow-sm">
                  <MessageCircle size={20} />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-black text-[#9C97B8] uppercase tracking-widest">WhatsApp</p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-4 p-4 bg-white border border-[#E4E9F4] rounded-2xl hover:border-pink-200 hover:shadow-sm transition-all"
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-black text-[#9C97B8] uppercase tracking-widest">Instagram</p>
          ...
          <section className="space-y-4">
            ...
            {filteredGroups.length === 0 ? (
              <div className="text-center py-10 bg-slate-50 rounded-xl border border-[#E4E9F4]">
                <HelpCircle size={28} className="text-gray-200 mx-auto mb-2" />
                <p className="text-sm font-bold text-[#9C97B8]">{t("noMatches", { query })}</p>
              ...
              filteredGroups.map((group) => (
                <div key={group.title} className="space-y-2">
                  ...
                  <div className="bg-white border border-[#E4E9F4] rounded-xl overflow-hidden">
                      ...
                      return (
                        <div key={id} className="border-b border-slate-50 last:border-0">
                          <button
                            ...
                            type="button"
                          >
                            <span className="text-sm font-bold text-gray-700 group-hover:text-[#16224E] pr-3">
                              {item.q}
                            </span>
                            {isOpen ? (
