...
export default function Comparison() {
  return (
    <section data-screen-label="Comparison" style={{ maxWidth: "1280px", margin: "0 auto", padding: "88px 40px 0" }}>
      ...
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <h2 style={{ fontSize: "42px", fontWeight: 800, letterSpacing: "-0.025em", margin: 0 }}>Agencies had a good run.</h2>
        <span style={{ fontSize: "12.5px", fontWeight: 800, letterSpacing: "0.12em", color: "#9CA3AF" }}>WHY RGOSSIPS · SIDE BY SIDE</span>
      </div>
      <div style={{ marginTop: "40px", background: "linear-gradient(#FFFFFF, #FFFFFF) padding-box, linear-gradient(135deg, rgba(244,114,182,0.5), rgba(168,85,247,0.25) 45%, rgba(124,58,237,0.5)) border-box", border: "1.5px solid transparent", borderRadius: "24px", overflow: "hidden", boxShadow: "0 10px 30px rgba(124,58,237,0.09)" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1.15fr", padding: "18px 30px", borderBottom: "1px solid #F1F0F5", alignItems: "center" }}>
        ...
        {comparisons.map((c, i) => (
          <div key={i} className="cmp-row" style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1.15fr", padding: "15px 30px", borderBottom: `1px solid ${c.border}`, alignItems: "center", transition: "background 0.2s ease" }}>
