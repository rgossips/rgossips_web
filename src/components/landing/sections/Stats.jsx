...
export default function Stats() {
  ...
  return (
    <section data-screen-label="Stats" style={{ maxWidth: "1280px", margin: "0 auto", padding: "24px 40px 0" }}>
      <div ref={statsRef} style={{ position: "relative", background: "linear-gradient(120deg, #1E1B2E, #2D2350)", borderRadius: "28px", padding: "46px 40px", color: "#FFFFFF", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: "20px", textAlign: "center" }}>
          {stats.map((s, i) => (
            <div key={i}>
              <div style={{ fontSize: "34px", fontWeight: 800, letterSpacing: "-0.02em", background: "linear-gradient(95deg, #C4B5FD, #F9A8D4)", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent" }}>{s.display}</div>
