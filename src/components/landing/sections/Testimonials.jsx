...
export default function Testimonials() {
  return (
    <section data-screen-label="Testimonials" style={{ padding: "88px 0 0", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 40px", display: "flex", alignItems: "baseline", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        <h2 style={{ fontSize: "42px", fontWeight: 800, letterSpacing: "-0.025em", margin: 0 }}>Loved on both sides of the deal.</h2>
