...
export default function MobileApp() {
  return (
    <section data-screen-label="Mobile app" className="mba-section" style={{ maxWidth: "1280px", margin: "0 auto", padding: "88px 40px 0" }}>
      <style>{`.ma-store:hover{background:#1E1B2E}`}</style>
      <div className="mba-wrap" style={{ position: "relative", background: "linear-gradient(120deg, #F3EEFD, #FBEAF4)", borderRadius: "28px", padding: "56px 52px", display: "grid", gridTemplateColumns: "1.25fr 1fr", gap: "56px", alignItems: "center", overflow: "hidden" }}>
        ...
        <div>
          ...
          <h3 className="mba-title" style={{ fontSize: "36px", fontWeight: 800, letterSpacing: "-0.02em", margin: "14px 0 0", lineHeight: 1.15 }}>Run campaigns from the checkout line.</h3>
          <div className="mba-points" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px 26px", marginTop: "24px" }}>
            {appPoints.map((pt, i) => (
          ...
          <div className="mba-stores" style={{ display: "flex", alignItems: "center", gap: "12px", marginTop: "30px", flexWrap: "wrap" }}>
            <Link href="/login" className="ma-store mba-badge" style={{ display: "inline-flex", flexDirection: "column", background: "#111827", color: "#FFFFFF", borderRadius: "14px", padding: "9px 20px", lineHeight: 1.25 }}><span style={{ fontSize: "10px", fontWeight: 600, color: "rgba(255,255,255,0.6)" }}>Download on the</span><span style={{ fontSize: "15px", fontWeight: 800, color: "#FFFFFF" }}>App Store</span></Link>
            <Link href="/login" className="ma-store mba-badge" style={{ display: "inline-flex", flexDirection: "column", background: "#111827", color: "#FFFFFF", borderRadius: "14px", padding: "9px 20px", lineHeight: 1.25 }}><span style={{ fontSize: "10px", fontWeight: 600, color: "rgba(255,255,255,0.6)" }}>Get it on</span><span style={{ fontSize: "15px", fontWeight: 800, color: "#FFFFFF" }}>Google Play</span></Link>
            <span className="mba-rating" style={{ fontSize: "12.5px", fontWeight: 800, color: "#9CA3AF", marginLeft: "6px" }}>4.8★ iOS · 4.7★ ANDROID</span>
          </div>
        </div>
        <div style={{ position: "relative", display: "flex", justifyContent: "center", padding: "20px 0" }}>
          <div className="mba-phone" style={{ position: "relative", width: "250px", background: "#111827", borderRadius: "40px", padding: "10px", boxShadow: "0 30px 70px rgba(30,27,46,0.35)" }}>
            ...
            <div className="mba-notif" style={{ position: "absolute", top: "54px", left: "-34px", right: "-34px", background: "#FFFFFF", borderRadius: "14px", padding: "10px 14px", boxShadow: "0 16px 40px rgba(17,24,39,0.16)", display: "flex", alignItems: "center", gap: "10px", animation: "notifIn 5s ease-in-out infinite" }}>
      ...
      <style>{`
        @media (max-width: 767px) {
          .mba-section { padding: 64px 20px 0 !important; }
          .mba-wrap { grid-template-columns: 1fr !important; padding: 36px 20px !important; gap: 40px !important; }
          .mba-title { font-size: 26px !important; }
          .mba-points { grid-template-columns: 1fr !important; gap: 12px !important; }
          .mba-stores { justify-content: center !important; }
          .mba-badge { width: 100% !important; align-items: center !important; }
          .mba-rating { width: 100% !important; margin-left: 0 !important; text-align: center !important; }
          .mba-phone { width: 70vw !important; max-width: 250px !important; }
          .mba-notif { left: -12px !important; right: -12px !important; }
        }
      `}</style>
    </section>
  );
