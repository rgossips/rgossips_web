...
const MyInformationDetail = ({ onBack, onAddReel }) => {
  ...
  return (
    <main className="p-5 space-y-6 pb-24 relative">
      {/* Header */}
      <button
        onClick={onBack}
        className="p-2 bg-pink-100/50 rounded-full text-pink-500 mb-2 active:scale-90 transition-transform"
      >
        <ArrowLeft size={20} />
      </button>
      ...
      <section className="bg-white rounded-[2.5rem] border-2 border-pink-100 p-6 shadow-sm flex flex-col items-center relative">
        ...
        <div className="text-center mt-3 space-y-1">
          <p className="text-[11px] font-bold text-gray-600 flex items-center justify-center gap-1">
            <span className="text-gray-400">🎬</span> Men's Lifestyle, Skincare
            & Grooming Tips
          </p>
      ...
      <section className="space-y-3">
        <div className="flex justify-between items-center px-1">
          ...
          <button className="text-[10px] font-black text-gray-400 flex items-center gap-1 border border-gray-100 px-3 py-1 rounded-full">
          ...
          {reels.map((reel) => (
            ...
            >
              ...
              <button
                ...
                className="absolute top-3 right-3 bg-white/90 p-1.5 rounded-full text-gray-800 shadow-sm hover:bg-white transition-colors"
              >
                <Edit2 size={10} />
              </button>
