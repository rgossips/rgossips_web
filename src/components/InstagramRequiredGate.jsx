...
export default function InstagramRequiredGate() {
  ...
  return (
    <div data-scroll-lock className="fixed inset-0 z-[300] bg-[#0F0F1A]/95 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6">
      {/* p-5 sm:p-8 so the card has room on 320–360px phones (was
          p-8 = 64px of padding, leaving < 260px for content). */}
      <div className="w-full max-w-md max-h-[90dvh] overflow-y-auto overscroll-contain bg-white rounded-3xl shadow-2xl p-5 sm:p-8 space-y-5">
