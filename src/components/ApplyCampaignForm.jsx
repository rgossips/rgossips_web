...
export function ApplyCampaignForm({ onClose, campaignData }) {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[60] bg-white flex flex-col overflow-y-auto scrollbar-hide mb-16"
    >
      {/* Header */}
      <div className="p-6 flex items-center gap-4 border-b border-slate-50 sticky top-0 bg-white z-10">
        ...
        <h2 className="text-lg font-bold text-slate-800">Apply for Campaign</h2>
      </div>
      ...
      <div className="flex-1 p-6 space-y-8">
        ...
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 bg-[#B38B59] rounded-2xl flex items-center justify-center text-white text-2xl font-bold">
        ...
        <section className="space-y-4">
          ...
          <textarea
            ...
            className="w-full h-24 p-4 border border-slate-100 rounded-2xl text-sm text-slate-800 placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E60076]/20 resize-none"
          />
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              <label
                key={deliverable}
                className="flex items-center gap-3 p-3 rounded-2xl border border-slate-100 cursor-pointer hover:bg-slate-50 transition-colors"
              >
                <Checkbox
                  checked={formData.selectedDeliverables.includes(deliverable)}
        ...
        <div className="flex gap-4">
          <Button
            variant="outline"
            onClick={onClose}
            className="flex-1 h-14 rounded-2xl border-slate-100 font-bold text-slate-600"
          >
            Cancel
          </Button>
          <Button
            ...
            className="flex-1 h-14 rounded-2xl font-bold text-white bg-gradient-to-r from-[#9810FA] to-[#E60076] shadow-lg shadow-pink-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Submit Application
          </Button>
        </div>
