  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed z-[250] flex h-auto flex-col bg-background",
...
function DrawerFooter({
  ...
  return (
    <div
      ...
      className={cn("mt-auto flex shrink-0 flex-col gap-2 p-4 pb-[max(1rem,env(safe-area-inset-bottom))]", className)}
      {...props} />
  );
}
